...
alias ogo="ox --name go${_dx_id} -v ${_dx_dir}/gopkg:/opt/gopkg ${_dx_port} io:go zsh"
alias _ogo="ox -v ${_dx_id}/gopkg:/opt/cache io:go zsh"
alias opy="docker run -it --rm --name py${_dx_id} -p \$(usable_port 8888):8888 io:torch"
alias ojpl="docker run -it --rm --name jpl${_dx_id} -p \$(usable_port 8888):8888 io:jpl"
